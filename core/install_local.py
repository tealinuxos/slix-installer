...
def install_tea_local(selected_device, selected_device_efi, selected_time_region, selected_time_city, selected_lang, selected_keymap, selected_hostname, selected_username, selected_user_pass, selected_root_pass, selected_DE, package_list):
    if selected_device and selected_device_efi:
        ...
        # rsync-ing the new system
        rsync_command = "rsync --info=progress2 -aAXv --exclude='/etc/motd' --exclude='/etc/systemd/system/getty@tty1.service.d/*' --exclude='/etc/mkinitcpio.conf.d/*' --exclude='/etc/mkinitcpio.d/*' --exclude='/dev/*' --exclude='/proc/*' --exclude='/sys/*' --exclude='/tmp/*' --exclude='/usr/tmp/*' --exclude='/run/*' --exclude='/mnt/*' --exclude='/media/*' --exclude='/var/cache/*' --exclude='/lost+found/*' / /mnt"
